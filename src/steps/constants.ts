...
import { createCommonAssetSchema } from './utils';
...
> = {
  ...
  ASSET_IP: {
    ...
    schema: {
      properties: {
        ...createCommonAssetSchema(),
        ipAddress: { type: 'string' },
        name: { type: 'string' },
        alive: { type: 'boolean' },
        domainNames: { type: 'array', items: { type: 'string' } },
        locations: { type: 'array', items: { type: 'string' } },
        'openPorts.portNumbers': { type: 'array', items: { type: 'number' } },
        'openPorts.protocols': { type: 'array', items: { type: 'string' } },
        'closedPorts.portNumbers': { type: 'array', items: { type: 'number' } },
        'closedPorts.protocols': { type: 'array', items: { type: 'string' } },
      },
  ...
  ASSET_IP_RANGE: {
    ...
    schema: {
      ...
      required: ['id', 'CIDR', 'public', 'internal'],
    },
  },
  CVE: {
    resourceName: 'CVE',
...
export const MappedRelationships: Record<
  'ISSUE_IS_CVE' | 'ISSUE_IS_CYC',
  StepMappedRelationshipMetadata
> = {
  ISSUE_IS_CVE: {
    _type: 'cycognito_issue_is_cve',
    sourceType: Entities.ISSUE._type,
